...
/**
 * @brief String pop functor
 *
 * @param[in] _s - XPL context
 * @param[in] _o - Target buffer to be filled
 * @return - XPL status
 */
typedef xpl_status_t (* dt_pop_string_func_t)(xpl_context_t* _s, char** _o);
/**
...
/**
 * @brief Sets a string popper of a datatree
 *
 * @param[in] d - Target datatree
 * @param[in] p - String popper
 */
DT_API void dt_set_string_popper(dt_datatree_t d, dt_pop_string_func_t p);
